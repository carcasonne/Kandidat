...
if __name__ == "__main__":
    ...
    benchmark.benchmark(AST_model, for_test_loader, run_name1, True, DEVICE, WANDB_PROJECT_NAME, generate_attention_maps=True)
    
    run_name = "AST_benchmark_ADD"
    benchmark.benchmark(AST_model, add_test_loader, run_name, True, DEVICE, WANDB_PROJECT_NAME, generate_attention_maps=True)
    ...
    benchmark.benchmark(Pretrain_model, pre_add_test_loader, run_name2, False, DEVICE, WANDB_PROJECT_NAME, generate_attention_maps=True)

    run_name3 = "Pretrain_benchmark_FoR"
    benchmark.benchmark(Pretrain_model, pre_for_test_loader, run_name3, False, DEVICE, WANDB_PROJECT_NAME, generate_attention_maps=True)
